...
func testKeyGeneration(t *testing.T, c *ec256k1.BitCurve, tag string) {
...
func TestKeyGeneration(t *testing.T) {
	testKeyGeneration(t, ec256k1.S256(), "S256")
}

func testSignAndVerify(t *testing.T, c *ec256k1.BitCurve, tag string) {
...
func TestSignAndVerify(t *testing.T) {
	testSignAndVerify(t, ec256k1.S256(), "S256")
}
...
func BenchmarkSign(b *testing.B) {
	b.StopTimer()
	priv, _ := GenerateKey(ec256k1.S256(), rand.Reader)
	hashed := []byte("testing")
	b.StartTimer()
