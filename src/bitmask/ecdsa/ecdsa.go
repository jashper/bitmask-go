...
func randFieldElement(c *ec256k1.BitCurve, rand io.Reader) (k *big.Int, err error) {
...
func GenerateKey(c *ec256k1.BitCurve, rand io.Reader) (priv *PrivateKey, err error) {
